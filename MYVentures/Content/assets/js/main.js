...
-------------------------------------------------- */
	function initRangeSlider () {
	    debugger;
	    var max = $("#shop-slider-range-amount").attr("max");
	    var smax = $("#shop-slider-range-amount").attr("smax");
	    var smin = $("#shop-slider-range-amount").attr("smin");
		$( "#shop-slider-range" ).slider({
			range: true,
			min: 0,
			max: max,
			values: [ smin, smax ], // starting values
			slide: function( event, ui ) {
			    $("#shop-slider-range-amount").val("Rs. " + ui.values[0] + " TO Rs. " + ui.values[1]);
			    $("#SPriceMin").val(ui.values[0]);
			    $("#SPriceMax").val(ui.values[1]);
			}
		});
		$( "#shop-slider-range-amount" ).val( "Rs. " + $( "#shop-slider-range" ).slider( "values", 0 ) +
			" TO Rs. " + $( "#shop-slider-range" ).slider( "values", 1 ) );
	...
	$.post(
			...
			function (data) {
                ...
                if(data.id == undefined)
                    ...
                    $("#"+data.id+" .ajax-message").html(data.text);
                }
			}
	);
});
